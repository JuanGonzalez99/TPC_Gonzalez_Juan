...
ADD CONSTRAINT FK_USUARIO_ALUMNO foreign key (CD_USUARIO) references TB_USUARIOS(CD_USUARIO)

ALTER TABLE TB_PROFESORES
ADD CONSTRAINT FK_USUARIO_PROFESOR foreign key (CD_USUARIO) references TB_USUARIOS(CD_USUARIO)

-- INSERTS
INSERT INTO TB_USUARIOS (NOMBRE_USUARIO, TIPO_USUARIO, MAIL, CONTRASEÑA)
VALUES ('FALABUI', 'Alumno', 'FALABUIGC@FRGP.UTN.AR', 'DRAGON123')
INSERT INTO TB_USUARIOS (NOMBRE_USUARIO, TIPO_USUARIO, MAIL, CONTRASEÑA)
VALUES ('DLOSTERK', 'Alumno', 'DLOSTERK@FRGP.UTN.AR', 'TODOPODEROSO01')
INSERT INTO TB_USUARIOS (NOMBRE_USUARIO, TIPO_USUARIO, MAIL, CONTRASEÑA)
VALUES ('MAR', 'Profesor', 'FMAR@FRGP.UTN.AR', 'STAR000WARS')
INSERT INTO TB_USUARIOS (NOMBRE_USUARIO, TIPO_USUARIO, MAIL, CONTRASEÑA)
VALUES ('LIMONS', 'Profesor', 'LSANGE@FRGP.UTN.AR', 'YODIGO')

INSERT INTO TB_ALUMNOS (CD_USUARIO, NOMBRE, APELLIDO, FECHA_NAC)
VALUES (1, 'Fernando', 'Calabuig', '20-jun-1985')
INSERT INTO TB_ALUMNOS (CD_USUARIO, NOMBRE, APELLIDO, FECHA_NAC)
VALUES (2, 'Dloster', 'Kaniel', '14-may-1958')

INSERT INTO TB_PROFESORES (CD_USUARIO, NOMBRE, APELLIDO, FECHA_NAC, FECHA_INGRESO)
VALUES (3, 'Saximiliano', 'Mar', '3-nov-1988', '1-mar-2008')
INSERT INTO TB_PROFESORES (CD_USUARIO, NOMBRE, APELLIDO, FECHA_NAC, FECHA_INGRESO)
VALUES (4, 'Limon', 'Sange', '28-jan-1982', '28-jul-2010')
